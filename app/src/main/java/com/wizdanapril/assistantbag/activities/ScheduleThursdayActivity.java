...
import com.wizdanapril.assistantbag.adapters.ScheduleThursdayAdapter;
...
public class ScheduleThursdayActivity extends AppCompatActivity implements View.OnLongClickListener {

    private String day = "thurday";

    private LinkedMap<String, Boolean> scheduleList, selectionList;

    private DatabaseReference scheduleReference, catalogReference;

    private ScheduleThursdayAdapter scheduleAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mondayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ScheduleThursdayActivity.this,
        ...
        deleteIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                scheduleAdapter.removeAdapter(selectionList, ScheduleThursdayActivity.this);
                clearActionMode();
            }
        });
        ...
        scheduleAdapter = new ScheduleThursdayAdapter(scheduleList, this,
        ...
        plusIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ScheduleThursdayActivity.this, SelectionActivity.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(ScheduleThursdayActivity.this, HomeActivity.class));
    }
}
