...
import com.wizdanapril.assistantbag.adapters.ScheduleWednesdayAdapter;
...
public class ScheduleWednesdayActivity extends AppCompatActivity implements View.OnLongClickListener {
    ...
    private ScheduleWednesdayAdapter scheduleAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mondayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ScheduleWednesdayActivity.this,
        ...
        deleteIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                scheduleAdapter.removeAdapter(selectionList, ScheduleWednesdayActivity.this);
                clearActionMode();
            }
        });
        ...
        scheduleAdapter = new ScheduleWednesdayAdapter(scheduleList, this,
        ...
        plusIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ScheduleWednesdayActivity.this, SelectionActivity.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(ScheduleWednesdayActivity.this, HomeActivity.class));
    }
}
