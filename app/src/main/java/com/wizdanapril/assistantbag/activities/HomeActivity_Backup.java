...
//        }
        ...
        menuSchedule.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity_Backup.this, ScheduleActivity.class));
        ...
        menuCatalog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity_Backup.this, CatalogActivity.class));
                drawer.closeDrawer(navigationView);
            }
        });
        ...
        menuNetwork.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity_Backup.this, NetworkActivity.class));
                drawer.closeDrawer(navigationView);
            }
        });
        ...
        menuCopyright.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity_Backup.this, AboutusActivity.class));
                drawer.closeDrawer(navigationView);
            }
        });
        ...
        menuLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(HomeActivity_Backup.this, LoginActivity.class));
                drawer.closeDrawer(navigationView);
                finish();
            }
        });
...
//        speechButton.bringToFront();
        speechButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(HomeActivity_Backup.this, SpeechRecognitionActivity_Re.class));
            }
        });
    }
...
//    }
    ...
    private class PagerAdapter extends FragmentPagerAdapter {
        ...
        public View getTabView(int position) {
            ...
            View view = LayoutInflater.from(HomeActivity_Backup.this).inflate(R.layout.snippet_custom_tab, null);
