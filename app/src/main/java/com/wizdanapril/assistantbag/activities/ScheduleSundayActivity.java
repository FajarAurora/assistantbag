...
import com.wizdanapril.assistantbag.adapters.ScheduleSundayAdapter;
...
public class ScheduleSundayActivity extends AppCompatActivity implements View.OnLongClickListener {
    ...
    private ScheduleSundayAdapter scheduleAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_schedule_sunday);
        ...
        mondayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ScheduleSundayActivity.this,
        ...
        deleteIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                scheduleAdapter.removeAdapter(selectionList, ScheduleSundayActivity.this);
                clearActionMode();
            }
        });
        ...
        scheduleAdapter = new ScheduleSundayAdapter(scheduleList, this,
        ...
        plusIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ScheduleSundayActivity.this, SelectionActivity.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(ScheduleSundayActivity.this, HomeActivity.class));
    }
}
