...
import com.wizdanapril.assistantbag.adapters.ScheduleSaturdayAdapter;
...
public class ScheduleSaturdayActivity extends AppCompatActivity implements View.OnLongClickListener {
    ...
    private ScheduleSaturdayAdapter scheduleAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_schedule_saturday);
        ...
        mondayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ScheduleSaturdayActivity.this,
        ...
        deleteIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                scheduleAdapter.removeAdapter(selectionList, ScheduleSaturdayActivity.this);
                clearActionMode();
            }
        });
        ...
        scheduleAdapter = new ScheduleSaturdayAdapter(scheduleList, this,
        ...
        plusIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ScheduleSaturdayActivity.this, SelectionActivity.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(ScheduleSaturdayActivity.this, HomeActivity.class));
    }
}
