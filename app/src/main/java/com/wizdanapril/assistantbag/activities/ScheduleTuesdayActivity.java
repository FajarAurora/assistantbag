...
import com.wizdanapril.assistantbag.adapters.ScheduleTuesdayAdapter;
...
public class ScheduleTuesdayActivity extends AppCompatActivity implements View.OnLongClickListener {
    ...
    private ScheduleTuesdayAdapter scheduleAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mondayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ScheduleTuesdayActivity.this,
        ...
        deleteIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                scheduleAdapter.removeAdapter(selectionList, ScheduleTuesdayActivity.this);
                clearActionMode();
            }
        });
        ...
        scheduleAdapter = new ScheduleTuesdayAdapter(scheduleList, this,
        ...
        plusIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ScheduleTuesdayActivity.this, SelectionActivity.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(ScheduleTuesdayActivity.this, HomeActivity.class));
    }
}
